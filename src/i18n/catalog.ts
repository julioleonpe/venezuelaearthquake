...
const en = {
  ...
  "relief.filter.acopio": "Collection centers",
  "relief.filter.refugio": "Shelters",
  ...
  // Need-category filter (acopios): chips highlight centers collecting each item.
  "relief.needs.aria": "Highlight collection centers by what they need",
  "relief.needs.label": "Highlight by need",
  ...
  "relief.cat.hygiene": "Hygiene",
  "relief.cat.clothing": "Clothing",
  "relief.cat.bedding": "Bedding",
  "relief.cat.power": "Power & light",
  "relief.cat.pets": "Pet supplies",
  "relief.cat.tools": "Tools & gear",
...
const es: Record<MessageId, string> = {
  ...
  // Filtro por categoría de necesidad (acopios): resalta centros por lo que reciben.
  "relief.needs.aria": "Resaltar centros de acopio por lo que necesitan",
  "relief.needs.label": "Resaltar por necesidad",
  ...
  "relief.cat.hygiene": "Higiene",
  "relief.cat.clothing": "Ropa",
  "relief.cat.bedding": "Descanso",
  "relief.cat.power": "Energía y luz",
  "relief.cat.pets": "Mascotas",
  "relief.cat.tools": "Herramientas",
