 ...
 *
 * This is a STATIC SNAPSHOT, not a live feed. A script
 ...
 * instantly and can never be "unavailable" — at the cost of being at most a little
 * stale, which is fine for a moderated registry that changes slowly. Refresh it by
 * re-running the script and redeploying.
 *
