/**
 * Daily relief-points refresh — snapshots the community acopios/refugios feed
 * into a bundled JSON file the SPA ships statically.
 *
 ...
 *   - a serverless proxy to work around that was the source of the recurring
 *     "live relief-point data is temporarily unavailable" failures on Vercel.
 *
 ...
 * map renders instantly and can never be "unavailable". Re-run this daily and
 * redeploy to refresh:
 *
